  ...
  let query = supabase
    ...
    .select(
      `id, content, file_url, status, submitted_at,
       intern:intern_id (id, full_name, email, mentor_id, avatar_url),
    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-6xl">
      ...
      {filtered.length === 0 ? (
        <EmptyState
          ...
          description="When interns submit work for review, it'll appear here."
        />
      ) : (
          ...
          {filtered.map((sub: any) => {
            ...
            return (
              <Link
                ...
                className="block bg-white border border-slate-200 rounded-xl p-4 sm:p-5 hover:border-slate-400 transition-colors"
              >
