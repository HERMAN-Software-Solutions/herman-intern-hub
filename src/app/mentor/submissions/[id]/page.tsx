...
import { ReviewActions } from '@/app/admin/submissions/[id]/review-actions'
...
export default async function MentorSubmissionDetailPage({
  ...
  if (internIds.length === 0) notFound()

  // Fetch submission, but only if it belongs to one of mentor's interns
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-4xl">
      ...
      {sub.intern && (
        <Card className="mb-6">
          <div className="flex items-center gap-3">
            ...
            <Link
              href={`/mentor/interns/${sub.intern.id}`}
      ...
      {/* Review actions — reuses admin component */}
